...
cmip6_path <- "/Users/bbrunckhorst/Library/CloudStorage/OneDrive-WBG/Household survey locations to H3/02_data/raw/cmip6"
...
# ---------------------------------------------------------------------------
# Helper: H3 cells -> snapped CMIP6 grid points
# ---------------------------------------------------------------------------
